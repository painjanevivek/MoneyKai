...
| R-007 | The Android-first India/INR customer hypothesis and activation/retention targets have no production baseline, so the team could optimize the wrong experience or misstate product-market evidence. | Product / growth | 4×4=16 High | Versioned product/scope/KPI contracts; targets explicitly provisional; cohort maturity, denominator, confidence, guardrails, trust research, dogfood and beta evidence required. | 3×3=9 Medium | Establish baselines in M14/M15, approve or tighten targets, and require governed experiments before any M17 product-market-fit claim. | Founder/product analytics owner (`@painjanevivek`) | M15 gate; M17 claim review | Weak activation/retention, trust misunderstanding, sample bias, immature cohort, or target relaxation without ADR | Open; blocks unsupported PMF claims, not M01 definition | None |
| R-008 | Historical Flutter AAB, reviewer notes, Data Safety answers, and local-only claims describe a different product than the target Expo/Firebase/synchronization V1, so reuse could mislead Play review or users. | Release / privacy / product | 4×5=20 Critical | M01 scope explicitly supersedes historical target-release assumptions; old artifacts remain labelled historical; M12 requires fresh build identity, manifest/permission audit, SDK/data inventory, privacy/Data Safety reconciliation, and reviewer notes. | 2×5=10 Medium | Regenerate every Play and privacy declaration from the signed candidate; add stale-artifact checks and prohibit copying historical answers without candidate verification. | Android release/privacy owner (`@painjanevivek`) | M12 gate | Any candidate/store field cites old Flutter hash/version/local-only behavior or disagrees with observed Expo build | Open; blocks M12/M16 | None |

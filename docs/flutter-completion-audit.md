...
| Android permission audit | Complete for current artifacts | Phase 6 docs and `.\tool\audit_android_release.ps1` verify compiled APK identity/version/label/launch/ARM64 ABI and no restricted SMS/storage/contact/camera/mic/location permissions. |

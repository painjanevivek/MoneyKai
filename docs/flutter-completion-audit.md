...
| No dead routes / visible broken buttons | Complete for current MVP | Widget tests and emulator QA cover navigation/settings actions, including signed-out protected-route redirects; coming-soon backend/auth/store work is documented outside the MVP UI surface. |

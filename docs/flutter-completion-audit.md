...
| Android permission audit | Complete for current artifacts | Phase 6 docs and `.\tool\audit_android_release.ps1` verify compiled APK identity/version/label and no restricted SMS/storage/contact/camera/mic/location permissions. |

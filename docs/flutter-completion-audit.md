...
| Security/privacy self-review | Partially complete | Permissions, Android backup/data-extraction opt-out, local-only boundaries, enforced storage namespace, reset namespace, plaintext export contents, encrypted backups, local diagnostics clearing, and privacy copy are documented; local storage is not encrypted and real auth/backend sync remain future work. |

...
- [x] M01.GATE Pass `PROD-01`; push `feat(milestone-01) : complete product definition`. ([evidence](../../docs/operations/roadmap/M01/M01.GATE-product-definition.md))
...
- [x] M02.4 Apply progressive disclosure to onboarding, dashboard, transactions, budgets, groups, account, Trust Center, and settings. ([evidence](../../docs/operations/roadmap/M02/M02.4-progressive-disclosure.md))

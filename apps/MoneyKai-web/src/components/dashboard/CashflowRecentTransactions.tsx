...
const styles = StyleSheet.create({
  ...
  tableRow: { minHeight: 34, flexDirection: 'row', alignItems: 'center', paddingHorizontal: Spacing.md, gap: Spacing.md },
  tableHeader: { minHeight: 28, borderBottomWidth: 1 },
  ...
  transactionIcon: { width: 24, height: 24, flexShrink: 0, borderRadius: 6, alignItems: 'center', justifyContent: 'center' },

...
export const Colors = {
  ...
  jetLuxuryDark: {
    ...
    chart8: '#7FA6A1',
    shadowColor: '#000000',
    overlay: 'rgba(17, 16, 14, 0.78)',
    glassBg: 'rgba(29, 27, 24, 0.78)',
    glassBorder: 'rgba(231, 229, 224, 0.18)',
  },
  jetLuxuryLight: {
    primary: '#1F1F1D',
    primaryLight: '#5F5E59',
    ...
    chart8: '#6F8F89',
    shadowColor: '#1F1F1D',
    overlay: 'rgba(31, 31, 29, 0.42)',
    glassBg: 'rgba(255, 255, 255, 0.86)',
    glassBorder: 'rgba(31, 31, 29, 0.12)',
  },
  emeraldMistDark: {
    primary: '#8FE8D8',
    primaryLight: '#C8FFF4',
  ...
  aurora: {
    ...
    glassBorder: 'rgba(37, 99, 235, 0.22)',
  },
  pearl: {
    primary: '#1D4ED8',
    primaryLight: '#60A5FA',
...
export const THEME_OPTIONS: readonly ThemeOption[] = [
  {
    id: 'jetLuxury',
    label: 'Notion White',
    description: 'Clean white workspace with soft neutral sections',
    icon: 'square-rounded-outline',
    swatches: ['#F7F6F3', '#FFFFFF', '#1F1F1D'],
  },
  {
    id: 'emeraldMist',
    label: 'Emerald Mist',
